...
DEFAULT_DEMO_PROJECT = Path("/tmp/loopx-demo")
    ...
    *,
    ...
    return {
        ...
        "next_commands": [
            ...
            f'loopx --registry "$registry" --format json quota should-run --goal-id {goal_id} --host-surface generic_cli --scheduler-owner agent_cli_loop --execution-mode interactive',
        ],
