...
PR_REVIEW_CATALOG_ENTRY: dict[str, Any] = {
    ...
    "boundaries": [
        ...
        "Only an explicit request-scoped PR selection may override queue ordering; it cannot override review_action_kind or exact-head idempotency, and Todo prose, monitor notes, and one-off author filters are not scheduling authority.",
