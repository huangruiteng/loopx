        ...
        "domain_route_hints": {
            "issue_fix_workflow": {
                ...
                "writeback": (
                    ...
                    "reviewer-request, verify the visible request, then keep a continuous_monitor "
