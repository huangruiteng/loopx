...
| P1 | Research and material registry loops | `docs/operations/authority-source-registration.md` | `authority_source_v0`, compact source contracts, and freshness checks so durable materials can guide routing without copying source bodies or private links. |
| P2 | Public frontstage/showcase adoption | `docs/product/surfaces/frontstage-two-surface-strategy.md`, `docs/showcases/README.md` | `showcase_case_v0` and public-safe synthetic fixtures so demos explain LoopX without leaking live control state or turning showcase UI into control authority. |
| P2 | Office operations and partner connectors | `docs/product/surfaces/intelligent-management-surface.md` | Generic `connector_observation_v0`, `signal_v0`, and review-feed cards so partner tools can send compact work signals before LoopX owns any domain executor. |
