...
The current release anchor is LoopX GitHub release `v1.0.5`. Local command examples were checked against
the public `loopx 1.0.5` CLI and protocol surface. This release requires Python 3.11+ and Node.js 22.18.0+.
